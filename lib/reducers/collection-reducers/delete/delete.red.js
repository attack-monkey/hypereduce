...
exports.DELETE = function (collectionState, action) {
    return apply_fn_1.apply(action, function (deleteAction) {
        return deleteAction.collection === collectionState.collection
            ? apply_fn_1.apply(collectionState.allIds.filter(function (id) { return id !== deleteAction.id; }), function (allIds) {
                return ({
