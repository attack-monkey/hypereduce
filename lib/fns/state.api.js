...
exports.getConnections = function (key) { return connectionsStore[key]; };
...
exports.connectAndEmitCurrent = function (key, fn) {
    connectionsSubscriptions[key]
        ? display_fn_1.display("Connections must be unique " + key + " has already been registered")
        : (function () {
            connectionsSubscriptions[key] = fn;
...
exports.dispatchAction = exports.dispatch; // alias
