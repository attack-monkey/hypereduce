...
var state_fns_1 = require("./state.fns");
exports.goto = function (path) {
    history.pushState(undefined, '', path);
    state_fns_1.dispatch(__assign(__assign({}, exports.returnRouteObject()), { type: 'ROUTE_CHANGE' }));
    window.scrollTo(0, 0);
};
exports.manageRoutes = function () {
    // dispatch the current route
    state_fns_1.dispatch(__assign({ type: 'ROUTE_CHANGE' }, exports.returnRouteObject()));
    try {
        if (window) {
            // on pop state
