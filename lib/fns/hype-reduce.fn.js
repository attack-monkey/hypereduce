...
exports.getConnectionsStore = function () { return connectionsStore; };
exports.getReducer = function () { return reducer; };
...
exports.goto = function (path) {
    ...
    exports.dispatch(__assign(__assign({}, exports.returnRouteObject()), { type: 'ROUTE_CHANGE' }));
    window.scrollTo(0, 0);
};
exports.hypeReduce = function (init, reduceObject) {
    ...
    exports.dispatch(__assign({ type: 'ROUTE_CHANGE' }, exports.returnRouteObject()));
};
...
var addToConnectionsStore = function (key, state) {
